...
_SYSTEM = (
    ...
    "statement, payslip, a photo of a person/pet/object/scene/screenshot with "
    "no document or medical content, or anything else that is not a health "
    "record — if the image isn't paperwork at all, it is not_medical, never "
    "other. other = a real medical/clinical document that doesn't fit the "
    "kinds above (e.g. a consult note, referral letter, insurance pre-auth).\n"
