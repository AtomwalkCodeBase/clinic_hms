...
from .portal_views import (
    ...
    PortalMyRecordsView,
    PortalDocumentListCreateView, PortalDocumentDetailView,
    PortalDocumentBatchView, PortalDocumentBatchProcessView, PortalDocumentZipView,
    PortalLabOrderListView, PortalLabOrderChoiceView,
...
urlpatterns = [
    ...
    path("documents/batch/",                PortalDocumentBatchView.as_view(), name="portal-documents-batch"),
