...
export const API_ENDPOINTS = {
  ...
  PLATFORM: {
    ...
    DOC_RULES:                `${API_V1}/platform/doc-rules/`,
    DOC_RULE:        (id) =>  `${API_V1}/platform/doc-rules/${id}/`,
    DOC_RULES_TEST:           `${API_V1}/platform/doc-rules/test/`,
    DOC_CLASSIFICATION_REPORT: `${API_V1}/platform/doc-classification/report/`,
    LLM_STATUS:               `${API_V1}/platform/llm/status/`,
    JOBS_RUNTIME:             `${API_V1}/platform/jobs/runtime/`,
    JOBS_ACTION: (kind, action) => `${API_V1}/platform/jobs/runtime/${kind}/${action}/`,
    JOBS_LOG:        (kind) => `${API_V1}/platform/jobs/runtime/${kind}/log/`,
    JOBS_TASKS:               `${API_V1}/platform/jobs/tasks/`,
    JOBS_RUN:                 `${API_V1}/platform/jobs/run/`,
    JOBS_SCHEDULES:           `${API_V1}/platform/jobs/schedules/`,
    JOBS_SCHEDULE:     (id) => `${API_V1}/platform/jobs/schedules/${id}/`,
    JOBS_SCHEDULE_RUN: (id) => `${API_V1}/platform/jobs/schedules/${id}/run/`,
    JOBS_HISTORY:             `${API_V1}/platform/jobs/history/`,
  },
  ...
  PORTAL: {
    ...
    SPECIALTIES:           `${API_V1}/portal/specialties/`,
    ...
    DOCUMENTS_STATUS:      `${API_V1}/portal/documents/status/`,
    DOCUMENTS_REVIEW:      `${API_V1}/portal/documents/review/`,
